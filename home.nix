...

{
  ...
  programs.starship = {
    ...
    settings = {
      format = "$hostname[](fg:purple bg:blue)$directory[](fg:blue bg:green)$git_branch$git_metrics";
	...
	symbol = "";
      ...
      git_metrics = {
        format = "([](fg:green bg:yellow)[+$added]($added_style))([-$deleted]($deleted_style))[ ](fg:yellow)";
